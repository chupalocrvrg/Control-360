                ...
                <div className="mt-8 bg-white dark:bg-neutral-800 rounded-3xl border-2 border-indigo-600 p-8 shadow-xl animate-in slide-in-from-bottom-4 duration-300">
                  <div className="flex justify-between items-start mb-6">
                    ...
                    <div className="flex gap-2">
                      <button 
                        className="px-4 py-2 bg-neutral-100 dark:bg-neutral-700 hover:bg-neutral-200 dark:hover:bg-neutral-600 rounded-xl text-xs font-black transition-all flex items-center gap-2"
                        onClick={() => {
                          // Trigger edit logic
                        }}
                      >
                      ...
                      <button className="px-4 py-2 bg-neutral-900 text-white hover:bg-black rounded-xl text-xs font-black transition-all flex items-center gap-2 shadow-lg shadow-black/10">
