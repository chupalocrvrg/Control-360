...
const ClientsAndCredits = lazy(() => import('./pages/ClientsAndCredits'));
              ...
              <Suspense fallback={<LoadingFallback />}>
                <Routes>
                  ...
                  <Route element={<Layout />}>
                    ...
                    <Route path="/clients" element={<SecurityGuard><ClientsAndCredits /></SecurityGuard>} />
                    <Route path="/portfolio" element={<SecurityGuard><PortfolioManagement /></SecurityGuard>} />
